...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![fetch_title, classify_item, reclassify_item, generate_title, generate_starter_categories, log_dev_cache_hit, open_library, hide_spotlight, submit_email, finalize_first_launch, frontend_ready, schedule_reminder, cancel_reminder, close_reminder_window, open_item_from_reminder])
        .setup(|app| {
            #[cfg(target_os = "macos")]
